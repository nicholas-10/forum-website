...
<nav class="navbar sticky-top navbar-expand-lg bg-body-tertiary" style="box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 15px;">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">  {{-- me-auto mb-2 mb-lg-0"> --}}
                    ...
                    <li class="nav-item">
                        <a class="{{'nav-link' . (request()->routeIs('post-page') ? ' active nav-link-bold' : '')}}" href="/post">Upload Post</a>
                    </li>
